...
Weiter wissen wir, dass $\Theta_1 := \mathcal{O}_1 \cap \Omega_1\hfill(2)$\\[2pt]
Ferner ist sind die Mengenoperationen $\cap$ und $\setminus$ distributiv zueinander $\hfill(3)$

$$
	o_1 \cap \Omega_1
	\up{=}{(1)} (\mathcal{O}_1 \setminus \Theta_1) \cap \Omega_1
	\up{=}{(3)} (\mathcal{O} \cap \Omega_1) \setminus (\Theta_1 \cap \Omega_1)
	\up{=}{(2)} (\mathcal{O} \cap \Omega_1) \setminus \Theta_1
$$$$
	\up{=}{(2)} \Theta_1 \setminus \Theta_1 = \o
$$
$\hfill\square$
