...
=======
    ...
    \node[state,accepting]  (q1q2)  [right of=q0]   {$\big\{q_1,q_2\big\}$};
    \node[state,accepting]  (q1q3)  [above of=q1q2] {$\big\{q_1,q_3\big\}$};
    \node[state,accepting]  (q2)    [below of=q1q2] {$\big\{q_2\big\}$};
    \node[state,accepting]  (q3)    [right of=q1q2] {$\big\{q_3\big\}$};
    \node[state,accepting]  (qs)    [right of=q3]   {SENKE};
...
>>>>>>> 005da2928a68baf4cde6640a54af0d765d2961d1
\end{tikzpicture}
