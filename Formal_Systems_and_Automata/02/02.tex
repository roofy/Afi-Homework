...
Sei $w \in L_{\text{suff}}(\mathcal{A})$ gegeben.
...
$(r_0, r_1 \cdots r_n)$ sodass $r_0 = q_0$ und $r_n \in F$.
Ferner gibt es durch $uw \in L(\mathcal{A})$ eine Zustandsfolge
$(x_0, \sigma_1, x_1, \sigma_2 \cdots \sigma_n, x_n)$ sodass $x_0 = r_n$, $x_n \in F$ und
