    ...
    \begin{center}
        ...
        \begin{forest}
            [$v_{\color{red}\varepsilon}$
                ...
                [$v_{\color{red}1}$, edge label={node [midway, sloped, above] {\color{blue}$\geq$}}
...
\begin{frame}[t]
    ...
    \visible<7->{
        ...
        \ \ Sofort dekodierbares $\mathcal{C}$ für $r,q,l$ konstruierbar.\hfill$\square$
    }
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{itemize}
        \item Anzahl dieser Blätter: {\color{red}$|L_i| = r^{h-\ell_i}$}
    \end{itemize}
    \strut
        \begin{center}
            \begin{tikzpicture}
