...
\textbf{(ii)}\\
Die Funktion ist im Intervall $(-\infty, 0)$ streng monoton steigend,
da die Exponentialfunktion streng monoton wachsend ist (III 3.21 c) und
das Polynom $1-4x^2$ im Intervall $(-\infty, 0)$ ebenfalls streng monoton wächst.\\
Die Funktion ist im Intervall $(0, \infty)$ streng monoton fallend,
da die Exponentialfunktion streng monoton wachsend ist (III 3.21 c) und
das Polynom $1-4x^2$ im Intervall $(0, \infty)$ streng monoton fällt, somit
also die ''Eingabe'' von $\exp$ immer geringer wird, also Insgesamt auch monoton fällt.

\textbf{(iii)}\\
Wenn man nun die Intervall $(-\infty, 0]$ und $[0, \infty)$ betrachtet, ändert sich
...
bleibt $f$ in beiden nun geschlossenen Intervallen streng monoton steigend bzw. fallend.
