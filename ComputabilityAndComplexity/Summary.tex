...
\begin{itemize}
    ...
    \item Für jede Variable $x_i$ erstelle 2 Zahlen $a_i^+, a_i^-$, dessen $i-te$ Ziffer
        ...
        wenn die zugehörige Variable in Klausel $c_j$ vorkommt. Man führt noch 2 Dummy-Zahlen $d_j,d_j'$
...
\textbf{Satz:} Beweismethode \textsf{P = NP} (Bzw. Auschlusskriterium \text{NP}-schwer und pseudopolynomiell)
